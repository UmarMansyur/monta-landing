<template>
    <section class="bg-gradient-to-b from-[#001c3b] to-[#00215E] text-white" id="features">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <div class="grid md:grid-cols-2 gap-12">
                <div class="lg:w-3/4">
                    ...
                    <p class="mt-5">
                        <a class="inline-flex items-center gap-x-1 font-medium text-orange-600 dark:text-orange-500"
                            href="#">
                            Selengkapnya
                ...
                <div class="space-y-6 lg:space-y-10">
                    ...
                    <div class="flex">
                        <!-- Icon -->
                        <span
                            class="flex-shrink-0 inline-flex justify-center items-center size-[46px] rounded-full border border-gray-200 bg-white text-orange-500 shadow-sm mx-auto">
